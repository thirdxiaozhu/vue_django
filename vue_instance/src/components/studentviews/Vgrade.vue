        ...
        <el-header style="height: 40px;" :span="5">
            <el-col :span="10">
                <el-breadcrumb separator="/" style="margin-top: 20px; font-size:large;">
                    ...
                    <el-breadcrumb-item style="font-weight: bold;">我的成绩</el-breadcrumb-item>
                </el-breadcrumb>
            </el-col>
        </el-header>
            <el-main>
                <el-table :data="tableData" style="width: 100%" ref="table">
                    ...
                    <el-table-column prop="grade" label="该科成绩"  align="center" >
                    </el-table-column>
                </el-table>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            initList(){
                var that = this;
                getTestlist({ 'stu_id': this.stu_id, 'type': 2 }).then(res =>{
                    console.log(res)
